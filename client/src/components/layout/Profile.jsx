...
import Pop from "../popUps/PopDeleteAcc.jsx";
...
function Profile() {
  ...
  return (
    <div className="w-full h-full relative">
      {Display && <Pop Close={Close} profile_id={profileID} />}
          ...
          <div className="w-[97%] flex content-center justify-evenly flex-wrap mt-2">
            <div className="flex justify-evelny w-full">
              <div className="flex justify-center flex-col flex-wrap w-1/2 ml-4">
                <p className="capitalize text-xl font-medium font-poppins ">
                  {userProfile.firstName} {userProfile.lastName}
                </p>
                <p className="capitalize text-base font-poppins pl-1">
                  {userProfile.nature}
                </p>
              </div>
            </div>
            ...
            <div className="sm:w-1/2 flex flex-col content-center justify-evenly flex-wrap mt-2 pl-1">
              ...
              >
                ...
                <p className="capitalize sm:text-base text-sm font-poppins ml-2">
                  Modifier le compte
                </p>
              </button>
              <button
                onClick={() => {
                  navigate(routes.PASSWORDEDIT);
                }}
                className="flex flex-wrap w-full border-l-[3px] border-l-[#E87D00] pl-3 ml-4 mb-3"
              >
              ...
              <button
                ...
                className="flex flex-wrap w-full border-l-[3px] border-l-[#E87D00] pl-3 ml-4"
              >
