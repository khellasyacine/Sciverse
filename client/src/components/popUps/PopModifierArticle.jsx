...
function PopModifierArticle({Close, Confirmer}) {
  return (
    <div className='h-full w-full bg-black bg-opacity-30 absolute flex flex-wrap justify-center content-center'>
        <div className='lg:h-[250px] h-[230px] w-[450px] bg-white border-none py-2 rounded-[20px] flex flex-col justify-evenly content-center flex-wrap'>
            <div className='flex justify-center lg:h-16 h-12'>
                <FaExclamationTriangle className="h-16 w-16"/>
            </div>
            <div className='flex justify-center pt-3'>
                <p className='lg:text-lg font-poppins font-medium lg:w-96 w-96 lg:px-0 px-2 text-center'>Etes-vous sur de vouloir vouloir sauvgarder les changement apporter sur cet Article ?</p>
            </div>
...
export default PopModifierArticle